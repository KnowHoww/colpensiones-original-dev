...
use App\Exports\generarDocumentacionNomina as generarDocumentacionNominaReports;
use App\Exports\generarDocumentacionReconocimiento as generarDocumentacionReconocimientoReports;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Facades\File;


class DocumentacionInformesSemanal implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Excel::store(new generarDocumentacionReconocimientoReports($idsFinalizadasReconocimiento, true), $nombreBase . 'investigacionesFinalizadasReconocimiento' . $complementoFinalizada . $contadorFinalizados . '.xlsx');
        Excel::store(new generarDocumentacionNominaReports($idsFinalizadasNomina, true), $nombreBase . 'investigacionesFinalizadasNomina' . $complementoFinalizada . $contadorFinalizados . '.xlsx');
        Excel::store(new generarDocumentacionReconocimientoReports($idsObjetadasReconocimiento, true), $nombreBase . 'investigacionesObjetadasReconocimiento' . $complementoObjetada .  $contadorObjetados . '.xlsx');
        Excel::store(new generarDocumentacionNominaReports($idsObjetadasNomina, true), $nombreBase . 'investigacionesObjetadasNomina' . $complementoObjetada .  $contadorObjetados . '.xlsx');
