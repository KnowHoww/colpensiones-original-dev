    ...
    <div class="content">
      ...
      <p style="page-break-before: always;">
            ...
            <table class="table-body">
                ...
                <tr>
                    <td>FIRMA:<br/>&nbsp;<br/>
                         @if( $contratista->firma   !=null)
					 <img src="../public/images/firmas/{{ $contratista->firma }}" height ="80px" />
					@endif
					{{ $InformesInvestigador->updated_at }}
	...
	>
            <table>
                <tr>
                 ...
                 <tr>
                    <td class="bg-primary" rowspan ="2"><b>RESPONSABLE <br/>
                            (Supervisor de la región)</b><br/>&nbsp;<br/>&nbsp;
                            </td>
                    <td>NOMBRE Y APELLIDO:<br/>
					@if($coordinador !=null)
						{{ $coordinador->identificacion }} - {{ $coordinador->nombres }}
					@endif
					&nbsp;</td>
                </tr>   
                 <tr>
                    ...
                    <td>FIRMA:<br/>
					@if($coordinador !=null)
                        @if($coordinador->firma  !=null)
						<img src="../public/images/firmas/{{ $coordinador->firma }}" height ="80px" />
                        @endif
					@endif
					</td>
                </tr>   
                ...
                <tr>
                    ...
                    <td colspan ="2">{{ $InformesInvestigador->observaciones }}<br/>&nbsp;<br/>&nbsp;<br/>&nbsp;&nbsp;</td>
                </tr>
            </table>
