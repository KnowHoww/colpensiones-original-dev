                        ...
                        <tbody>
                            @forelse ($investigaciones as $investigacion)
                                ...
                                <td class="align-middle">
                                    {{ date('Y-m-d H:i:s', strtotime($investigacion->MarcaTemporal)) != '1969-12-31' ? date('Y-m-d H:i:s', strtotime($investigacion->MarcaTemporal)) : '' }}
                                </td>
                                @if ($fechaLimite)
                                    <td class="align-middle">
                                        {{ date('Y-m-d H:i:s', strtotime($investigacion->FechaLimite)) != '1969-12-31' ? date('Y-m-d H:i:s', strtotime($investigacion->FechaLimite)) : '' }}
                                    </td>
                                @endif
                                @if ($fechaAprobacion)
                                    <td class="align-middle">
                                        {{ date('Y-m-d H:i:s', strtotime($investigacion->FechaAprobacion)) != '1969-12-31' ? date('Y-m-d H:i:s', strtotime($investigacion->FechaAprobacion)) : '' }}
                                    </td>
                                @endif
                                @if ($fechaObjecion)
                                    <td class="align-middle">
                                        {{ date('Y-m-d H:i:s', strtotime($investigacion->FechaObjecion)) != '1969-12-31' ? date('Y-m-d H:i:s', strtotime($investigacion->FechaObjecion)) : '' }}
                                    </td>
                                @endif
                                @if ($fechaFinalizacion)
                                    <td class="align-middle">
                                        {{ date('Y-m-d H:i:s', strtotime($investigacion->FechaFinalizacion)) != '1969-12-31' ? date('Y-m-d H:i:s', strtotime($investigacion->FechaFinalizacion)) : '' }}
                                    </td>
                                @endif
                                @if ($fechaCancelacion)
                                    <td class="align-middle">
                                        {{ date('Y-m-d H:i:s', strtotime($investigacion->FechaCancelacion)) != '1969-12-31' ? date('Y-m-d H:i:s', strtotime($investigacion->FechaCancelacion)) : '' }}
                                    </td>
                                @endif
